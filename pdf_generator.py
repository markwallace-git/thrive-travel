...
def generate_itinerary_pdf(trip_ bytes:
    ...
    # Title
    content.append(Paragraph(f"🤖 Thrive Travel: {trip_data.get('destination', 'Trip')}", title_style))
    ...
    for day in trip_data.get('itinerary', []):
        ...
        if 'weather' in day:
            content.append(Paragraph(f"🌤️ {day['weather']}", styles['Normal']))
    ...
    content.append(Paragraph(
        "<i>Generated by Thrive AI Travel Operator | thrive-travel.onrender.com</i>",
        styles['Normal']
    ))
